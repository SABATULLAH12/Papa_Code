...
namespace PaPaFunApp.Fill_PHRM_View2_new_Functions
{
    public static class Fill_PHRM_View2_new
    {
        /// <summary>
        ...
        private static string FillCustomTable(string rawString, string emailId)
        {
            ...
            string procName = "[papafuncapp_addRows_PHRM_View2_new]";
            string tableTypeName = "[dbo].[PHRM_View2_new]";
			...
			dt.Columns.Add(new DataColumn("Falg 2", typeof(string)));
			...
			dt.Columns.Add(new DataColumn("Channelnew", typeof(string)));
        ...
        [FunctionName("fill_PHRM_View2_new")]
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req,ILogger log)
        {
            log.LogInformation("fill_PHRM_View2_new triggered");

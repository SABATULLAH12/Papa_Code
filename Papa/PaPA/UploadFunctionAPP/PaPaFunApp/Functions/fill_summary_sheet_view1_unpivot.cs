...
namespace PaPaFunApp.Fill_Summary_Sheet_View1_unpivot_Functions
{
    public static class Fill_Summary_Sheet_View1_unpivot
    {
        /// <summary>
        ...
        private static string FillCustomTable(string rawString, string emailId)
        {
            ...
            string procName = "[papafuncapp_addRows_Summary_Sheet_View1_unpivot]";
            string tableTypeName = "[dbo].[Summary_Sheet_View1_unpivot]";
			...
			dt.Columns.Add(new DataColumn("Current value", typeof(decimal)));
			dt.Columns.Add(new DataColumn("Optimized value", typeof(decimal)));
        ...
        [FunctionName("fill_Summary_Sheet_View1_unpivot")]
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req,ILogger log)
        {
            log.LogInformation("fill_Summary_Sheet_View1_unpivot triggered");

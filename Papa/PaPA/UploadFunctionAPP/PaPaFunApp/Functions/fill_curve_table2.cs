...
namespace PaPaFunApp.Fill_Curve_table2_Functions
{
    public static class Fill_Curve_table2
    {
        /// <summary>
        ...
        private static string FillCustomTable(string rawString, string emailId)
        {
            ...
            string procName = "[papafuncapp_addRows_Curve_table2]";
            string tableTypeName = "[dbo].[Curve_table2]";
        ...
        [FunctionName("fill_Curve_table2")]
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req,ILogger log)
        {
            log.LogInformation("fill_Curve_table2 triggered");

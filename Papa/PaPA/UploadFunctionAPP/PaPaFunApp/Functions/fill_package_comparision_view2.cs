...
namespace PaPaFunApp.Fill_Package_Comparision_View2_Functions
{
    public static class Fill_Package_Comparision_View2
    {
        /// <summary>
        ...
        private static string FillCustomTable(string rawString, string emailId)
        {
            ...
            string procName = "[papafuncapp_addRows_Package_Comparision_View2]";
            string tableTypeName = "[dbo].[Package_Comparision_View2]";
        ...
        [FunctionName("fill_Package_Comparision_View2")]
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req,ILogger log)
        {
            log.LogInformation("fill_Package_Comparision_View2 triggered");

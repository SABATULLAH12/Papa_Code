...
namespace PaPaFunApp.Fill_Innovation_Package_View2_new_Functions
{
    public static class Fill_Innovation_Package_View2_new
    {
        /// <summary>
        ...
        private static string FillCustomTable(string rawString, string emailId)
        {
            ...
            string procName = "[papafuncapp_addRows_Innovation_Package_View2_new]";
            string tableTypeName = "[dbo].[Innovation_Package_View2_new]";
        ...
        [FunctionName("fill_Innovation_Package_View2_new")]
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req,ILogger log)
        {
            log.LogInformation("fill_Innovation_Package_View2_new triggered");
